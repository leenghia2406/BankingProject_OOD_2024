	...
	public void actionPerformed(ActionEvent e) {
		...
		if (src.equals("Thanh Toan Vay Btn")) {
			...
			if (kh != null) {
							...
							if (dialogResult == JOptionPane.YES_OPTION) {
								...
								if (kh.traNo(maPIN)) {
									JOptionPane.showMessageDialog(view,
											"Thanh toán vay thành công. Số dư tài khoản đã trừ đi số tiền vay.");
								} else {
									JOptionPane.showMessageDialog(view,
				...
				} else if (kh.getVay() == null) {
					JOptionPane.showMessageDialog(view, "Bạn hiện không có khoản vay nào!", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
				}
			}
